...
const Title: React.FC = () => {
  ...
  if (location === '/bigminecraftmap') {
    menuTitle = '대규모 마인크래프트 맵';
    menuContent =
      '마인크래프트 대규모 맵 200x200 이상 규모의 마인크래프트 맵입니다.';
  } else if (location === '/bundleandmiddleminecraftmap') {
